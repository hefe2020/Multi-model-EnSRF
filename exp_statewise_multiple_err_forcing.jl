...
function run_statewise_hybrid_forcing_sweep()
    ...
    for (forcing_name, F_wrong_vec) in forcing_sweep
        ...
        println("Running statewise forcing case: ", forcing_name)
...
results_all_states = run_statewise_hybrid_forcing_sweep();

#for plotting
plot_global_vs_statewise_across_forcings(results_global, results_statewise; burnin=5)