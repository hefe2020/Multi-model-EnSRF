...
function run_weighted_hybrid_sweep_single_setup()
    N = 40
    dt = 0.05
    timesteps = 1000
    obs_steps = 5
    ...
    for k in 1:timesteps
        ...
        if k in obs_idx_all
            ...
            # weighted hybrid forecast RMSE for all λ
            for λ in λ_grid
            ...
            # weighted hybrid analysis RMSE for all λ
            for λ in λ_grid
...
results_all = run_weighted_hybrid_sweep_single_setup();
